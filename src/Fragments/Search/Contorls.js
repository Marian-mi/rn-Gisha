...
const SearchControls = () => {
    ...
    const { setSearch, selectedSort } = searchCtx
    ...
    return (
        <View style={[Flex.Row, Styles.Container, Styles.Shadow]}>
            ...
            <Pressable style={{ flex: 5, ...Flex.Row, ...Styles.Wrapper }} onPress={() => setSearch({...searchCtx, showSortModal: true})}>
            ...
            <Pressable style={{ flex: 2, ...Flex.Centered }}>
